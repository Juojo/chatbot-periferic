...
def mostrar_respuesta(respuesta, nombre_chatbot, nombre_usuario):
...
def ejecutar(preguntas_almacenadas, nombre_chatbot):
    ...
    while pregunta_usuario != "salir":
        ...
        mostrar_respuesta(respuesta, nombre_chatbot, nombre_usuario) # Se muestra por pantalla
